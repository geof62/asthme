...
function fin() {
    ...
    if (porcentage<40)
        ...
        result.innerHTML = "<section style='margin-top: 10%'> <div class='col-md-4' style=\"float: left;\"> <img src='images/icone_medecin.png' width=200px> </div><p class='col-md-8'> Il est possible que ton asthme ne soit pas bien contrôlé !<br/> Va voir un pneumologue qui va te proposer de nouvelles solutions.<br/> <button href='https://www.doctolib.fr/pneumologue/?latitude=" + geo.lat + '&longitude=' + geo.long + "' id='search_pneumo' target='_blank' class='nav-link'>Clique ici pour trouver des pneumologues </button></p></section>";
}
